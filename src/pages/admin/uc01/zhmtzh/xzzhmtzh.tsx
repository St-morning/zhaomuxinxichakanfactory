...
import apiAdminUc01ZhmtzhXzbczmxx, { Data as D1, Message as M1, Result as R1 } from '../../../api/admin/uc01/zhmtzh/xzbczmxx';

/**
 * 新增招募通知
 */
export default function Xzzhmtzh({
	onChange
}: {
	onChange(): void;
}) {
	...
	return <>
		<Ui.Button.Add
			...
			onOK={async () => {
				const { bmfsh, bmjzhshj, bmkshshj, zhmgw, zhmrsh } = data;
				if (!zhmgw) {
				...
				await apiAdminUc01ZhmtzhXzbczmxx(data);
				setdata(initData);
				onChange();
			}}
		>
